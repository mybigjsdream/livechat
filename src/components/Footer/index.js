...
export const PoweredBy = ({ className, ...props }) => (
	<h3
		...
		{...props}
	>
		{/* {I18n.t("Powered by novjia.xyz").split("novjia.xyz")[0]}
		<a href="https://rocket.chat" target="_blank" rel="noopener noreferrer">
			<Logo
				className={createClassName(styles, "powered-by__logo")}
				width={60}
				role="img"
				aria-label="novjia.xyz"
			/>
		</a>
		{I18n.t("Powered by novjia.xyz").split("novjia.xyz")[1]} */}
	</h3>
);
